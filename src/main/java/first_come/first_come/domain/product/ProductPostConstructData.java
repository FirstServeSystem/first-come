...
//    public void init() {
//        // Sample products
//        Product product1 = Product.of("Product 1", 10000);
//        Product product2 = Product.of("Product 2", 20000);
//        Product product3 = Product.of("Product 3", 30000);
//        Product product4 = Product.of("Product 4", 40000);
//        Product product5 = Product.of("Product 5", 50000);
//
